...
#        plt.show()
        ...
        self.h, self.Aconv, self.rho, self.Cp = 10.0, 1./30., 2250.*self.X, 1200. # conv heat coeff [W/m^2-K], conv area ratio (Aconv/Acoat) [m^2/m^2], density per coated area [kg/m^2], specific heat capacity [J/kg-K]
...
num_diff_vars = len( numpy.concatenate( [c_centered, ca_centered, cc_centered, [T]] ) )
num_algr_vars = len(y0) - num_diff_vars
